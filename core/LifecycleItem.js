...
* FortiWeb instance, as well as info needed to clean up the related database entry.
*/

module.exports = class LifecycleItem {
    /**
     * @param {String} instanceId Id of the FortiWeb instance.
     ...
     * @returns {Object} object {FortiWebInstance, Timestamp, Detail}
     */
    toDb() {
        return {
