...
module.exports = class CloudPlatform {
     ...
     * Abstract class method.
     * @param {String} ip Ip of the FortiWeb which wants to become the master
     ...
     * Abstract class method.
     * @returns {String} Ip of the FortiWeb which should be the auto-sync master
     */
    async getElectedMaster() {
        await this.throwNotImplementedException();
    }
    /**
     * Get all existing lifecyle actions for a FortiWeb instance from the database.
     * Abstract class method.
     * @param {String} instanceId Instance ID of a FortiWeb.
